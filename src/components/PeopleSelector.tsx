    ...
    return (
      <motion.div
        ...
        className={`flex items-center justify-between p-2 rounded-xl border transition-all duration-200 group ${
          isSelected
            ? "bg-faria-lightPlum/20 border-white/10 hover:bg-faria-lightPlum/30 shadow-[0_2px_8px_rgba(232,55,172,0.05)]"
      ...
      >
        <div className="flex items-center gap-3">
          <input
            ...
            className="w-4.5 h-4.5 rounded border-faria-pink/30 text-faria-pink focus:ring-faria-pink cursor-pointer accent-faria-pink bg-faria-plum/40"
          />
          <div className="relative">
            <div className="w-9 h-9 rounded-xl bg-faria-pink/10 border border-faria-pink/20 flex items-center justify-center text-faria-paper text-sm font-bold leading-none">
              {initials}
            </div>
            <span className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2 border-[#070A14] ${clock.dot}`} />
          </div>
          <div>
            <span className="text-base font-medium text-[#EAF0FF] block leading-none">
              {person.name}
            </span>
            <span className="text-xs text-[#6B779C] flex items-center gap-1 mt-1 font-mono">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-panel rounded-2xl p-5">
        <div className="flex items-center justify-between mb-3.5">
          <div className="flex items-center gap-2">
            <Users className="h-4.5 w-4.5 text-faria-pink" />
          ...
          <button
            ...
            className="flex items-center gap-1 text-xs font-medium bg-faria-pink/10 text-faria-pink hover:bg-faria-pink/25 border border-faria-pink/30 px-2.5 py-1 rounded-xl transition-all"
          >
        ...
        <div className="grid grid-cols-2 gap-2 text-xs font-medium text-[#AEB9D6] mb-4.5">
          <button
            onClick={onSelectAll}
        ...
        <div className="space-y-4 max-h-[380px] overflow-y-auto pr-1 no-scrollbar">
          {youPerson && (
            <div className="space-y-1.5">
              <span className="text-xs tracking-wider uppercase font-bold text-[#6B779C] block px-1">
                You
              </span>
      ...
      <div className="glass-panel rounded-2xl p-4.5">
        <h4 className="font-display text-sm font-semibold text-[#EAF0FF] mb-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="flex items-center gap-2 p-1.5 rounded-lg bg-[#34D399]/5 border border-[#34D399]/15">
            ...
            <span className="text-xs text-[#AEB9D6]">Level 0: Free</span>
          </div>
          <div className="flex items-center gap-2 p-1.5 rounded-lg bg-[#5EEAD4]/5 border border-[#5EEAD4]/15">
            ...
            <span className="text-xs text-[#AEB9D6]">Level 1: Likely Free</span>
          </div>
          <div className="flex items-center gap-2 p-1.5 rounded-lg bg-[#FBBF24]/5 border border-[#FBBF24]/15">
            ...
            <span className="text-xs text-[#AEB9D6]">Level 2: Tentative</span>
          </div>
          <div className="flex items-center gap-2 p-1.5 rounded-lg bg-[#FB7185]/5 border border-[#FB7185]/15">
            ...
            <span className="text-xs text-[#AEB9D6]">Level 3: Busy / Off</span>
          </div>
        </div>
      </div>
      ...
      <div className="glass-panel rounded-2xl p-5 space-y-4">
        <div className="flex items-center gap-2 border-b border-white/5 pb-2.5">
          ...
          <h4 className="font-display text-sm font-semibold text-[#EAF0FF]">
        ...
        <div className="space-y-3">
          <label className="flex items-center justify-between cursor-pointer group">
            <span className="text-xs text-[#AEB9D6] group-hover:text-[#EAF0FF] transition-colors">
        ...
        <div className="pt-2 border-t border-white/5">
          <div className="flex items-center justify-between text-xs text-[#AEB9D6] mb-1.5">
          ...
          <input
            ...
            className="w-full accent-faria-pink h-1 bg-slate-800 rounded-lg cursor-pointer"
          />
        </div>

        {/* Custom Muted string rule */}
        <div className="pt-3 border-t border-white/5 space-y-2">
          <span className="text-xs tracking-wider uppercase font-bold text-[#6B779C] block">
            Title Muted Filters
          </span>
          <div className="flex gap-1.5">
            <input
              ...
              className="flex-1 bg-faria-plum border border-white/5 text-[#EAF0FF] text-xs rounded-xl px-2.5 py-1.5 focus:outline-none focus:border-faria-pink/45"
            />
            <button
              onClick={handleAddMutedTerm}
              className="px-2.5 py-1 text-xs bg-slate-800 hover:bg-slate-700 font-medium rounded-xl border border-white/5 text-[#EAF0FF]"
            >
              Add
            </button>
          </div>
          ...
          <div className="flex flex-wrap gap-1 mt-2 max-h-24 overflow-y-auto no-scrollbar">
            {(preferences.muted_titles || []).map((term) => (
              <span
                key={term}
                className="inline-flex items-center gap-1 bg-slate-900/80 border border-white/10 text-slate-350 text-xs px-2 py-0.5 rounded-full"
              >
                {term}
                <button
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-faria-plum/85 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-md border border-white/10 bg-faria-darkPlum/95 rounded-2xl p-6 shadow-2xl relative">
            <h3 className="font-display text-base font-semibold text-[#EAF0FF] mb-3 flex items-center gap-2">
              <Sparkles className="h-4.5 w-4.5 text-faria-pink" />
              Add Remote Teammate
            </h3>
            ...
            <div className="flex border-b border-white/10 mb-4 text-xs font-semibold">
              <button
                ...
                className={`flex-1 pb-2 border-b-2 transition-all ${addTab === "manual" ? "border-faria-pink text-[#EAF0FF]" : "border-transparent text-slate-500 hover:text-[#AEB9D6]"}`}
              >
                Manual Entry
              </button>
              <button
                ...
                className={`flex-1 pb-2 border-b-2 transition-all ${addTab === "google" ? "border-faria-pink text-[#EAF0FF]" : "border-transparent text-slate-500 hover:text-[#AEB9D6]"}`}
              >
              ...
              <form onSubmit={handleSubmitNewPerson} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-faria-plum border border-white/10 text-[#EAF0FF] rounded-xl px-3 py-2 text-xs focus:outline-none focus:border-faria-pink/50"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-faria-plum border border-white/10 text-[#EAF0FF] rounded-xl px-2 py-2 text-xs focus:outline-none focus:border-faria-pink/50 font-mono"
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-faria-plum border border-white/10 text-[#EAF0FF] rounded-xl px-2 py-2 text-xs focus:outline-none focus:border-faria-pink/50"
                    >
                ...
                <div className="flex gap-2 justify-end pt-4 border-t border-white/5">
                  ...
                  <button
                    type="submit"
                    className="bg-gradient-to-r from-faria-orange via-faria-pink to-faria-yellow hover:opacity-90 text-white text-xs font-bold px-4 py-2 rounded-xl transition-all shadow-[0_0_12px_rgba(232,55,172,0.3)]"
                  >
                    Save Teammate
                  </button>
                </div>
